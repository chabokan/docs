...
![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/domain_2.jpg)

سپس نام دامنه خود و سرویسی که می خواهید به آن متصل شوید را مشخص نمایید.

![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/domain_3.jpg)
...
![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/domain_4.jpg)

در صورتی که مراحل را به درستی انجام داده باشید عبارت متصل شد را در بخش دامنه های خود مشاهده میکنید.

![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/domain_6.jpg)

## افزودن ساب دامنه

ابتدا میبایست دامنه اصلی خود را به سرویس اضافه و متصل نموده و سپس وارد تنظیمات دامنه می شویم.

![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/dashboard-domain-subdomain-install.gif)

![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/domains-panel.jpg)

در این قسمت از پنل دامنه ها میتوانید برای دامنه خود به تعداد دلخواه ساب دامنه مشخص نمایید و آنها را مدیریت نمایید.

![افزودن دامنه به سرویس از طریق DNS در چابکان](https://s1.chabokan.net/docs/images/5.jpg)
