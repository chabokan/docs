...
![مدیریت Subdomains سرویس‌ها در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/dashboard-domain-subdomain-install.gif)

همانطور که در تصویر زیر مشاهده می نمایید، برای ورود به بخش ساب دامنه روی ساب دامنه ها در پنل سمت راست، کلیک مینماییم.

![مدیریت Subdomains سرویس‌ها در چابکان](https://s1.chabokan.net/docs/images/domains-panel.jpg)

در این قسمت از پنل دامنه ها میتوانید برای دامنه خود به تعداد دلخواه ساب دامنه مشخص نمایید و آنها را مدیریت نمایید.

![مدیریت Subdomains سرویس‌ها در چابکان](https://s1.chabokan.net/docs/images/5.jpg)
