...
![مدیریت تنظیمات Caching دامنه سرویس‌های چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/dashboard-domain-caching-install.gif)

همانطور که در تصویر زیر مشاهده می نمایید، برای ورود به بخش Caching روی تنظیمات Caching در پنل سمت راست، کلیک مینماییم.

![مدیریت تنظیمات Caching دامنه سرویس‌های چابکان](https://s1.chabokan.net/docs/images/domains-panel.jpg)
...
![مدیریت تنظیمات Caching دامنه سرویس‌های چابکان](https://s1.chabokan.net/docs/images/6.png)
