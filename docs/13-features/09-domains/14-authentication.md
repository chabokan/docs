...
برای استفاده از این قابلیت، ابتدا میبایست دامنه خود را به یکی از گیت های چابکان متصل نمایید.([راهنمای اتصال دامنه به گیت](/features/domains/gates/))

:::

ابتدا باید دامنه خود را به سرویس متصل نماییم و بعد از افزودن دامنه و اتصال آن، وارد تنظیمات دامنه می شویم.

![مدیریت محدودیت دسترسی دامنه سرویس‌ها در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/dashboard-domain-access-install.gif)
...
![مدیریت محدودیت دسترسی دامنه سرویس‌ها در چابکان](https://s1.chabokan.net/docs/images/domain-athentication-1.jpg)
...
![مدیریت محدودیت دسترسی دامنه سرویس‌ها در چابکان](https://s1.chabokan.net/docs/images/domain-athentication-2.jpg)
