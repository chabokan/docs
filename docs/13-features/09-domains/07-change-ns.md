...
![تغییر NS دامنه در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/change-ns-install.gif)

![تغییر NS دامنه در چابکان](https://s1.chabokan.net/docs/images/change-ns-1.jpg)

NS های مد نظر را ست کرده و به روی " به روزرسانی NS ها " کلیک نمایید تا NS های مد نظر ست شوند.

![تغییر NS دامنه در چابکان](https://s1.chabokan.net/docs/images/change-ns-2.jpg)
