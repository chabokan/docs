...
![مدیریت دامنه‌های سرویس در داشبورد چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/domain-management-dashboard-install.gif)

همانطور که در تصویر زیر مشاهده می نمایید، در این قسمت میتوان وضعیت دامنه(در حال اتصال و یا متصل شده) را مشاهده نمود.

![مدیریت دامنه‌های سرویس در داشبورد چابکان](https://s1.chabokan.net/docs/images/domains-panel.jpg)
...
![مدیریت دامنه‌های سرویس در داشبورد چابکان](https://s1.chabokan.net/docs/images/domains-panel-2.jpg)
