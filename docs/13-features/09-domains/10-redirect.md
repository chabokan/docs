...
![مدیریت redirect دامنه‌های سرویس در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/dashboard-domain-redirect-install.gif)

همانطور که در تصویر زیر مشاهده می نمایید، برای ورود به بخش ریدایرکت روی ریدایرکت دامنه در پنل سمت راست، کلیک مینماییم.

![مدیریت redirect دامنه‌های سرویس در چابکان](https://s1.chabokan.net/docs/images/domains-panel.jpg)
...
![مدیریت redirect دامنه‌های سرویس در چابکان](https://s1.chabokan.net/docs/images/23.jpg)
