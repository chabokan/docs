...
قسمت استقرارها به صورت پیشفرض غیرفعال می باشد و در منو سرویس قابل مشاهده نیست. شما می توانید با اولین deploy از طریق [CLI](/deploy/cli/) این قسمت را فعال کنید.
...
![استقرار سرویس‌های چابکان](https://s1.chabokan.net/docs/images/deploys.png)
