...
![دسترسی کنسول در سرویس‌های چابکان](https://s1.chabokan.net/docs/gifs/service/console.gif)
...
اگر نیاز به اجرای دستورات کنسول در هربار اجرای سرویس را دارید می‌توانید از [Hookها](/features/etc/hook/) استفاده کنید.
...
![دسترسی کنسول در سرویس‌های چابکان](https://s1.chabokan.net/docs/images/console-chabokan.jpg)