...
لاگ ها برای مانیتور کردن سرویس ها بسیار کاربردی می باشند و کمک می کنند با کارهایی که در استقرار سرویس انجام می شود آشنا شوید. برای مثال زمانی که شما [cron jobs](/features/etc/cron-job/) های سرویس را فعال کند در لاگ استقرار به شما نمایش داده می شود که آیا این عملیات انجام شده است یا خیر.
