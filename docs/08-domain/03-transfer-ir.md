...
![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/domain-transfer-install.gif)

![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/images/domain_1.jpg)
...
![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/images/domain-11.jpg)
...
![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/images/domain-12.jpg)
...
![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/images/domain-rabet-1.png)

سپس مقدار فیلد تمامی رابط ها را ایرینیک چابکان (`fa482-irnic`) قرار دهید و بر روی **ثبت تغییرات** کلیک فرمایید.

![انتقال دامنه‌های IR به چابکان](https://s1.chabokan.net/docs/images/domain-rabet-2.png)
