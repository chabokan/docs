...
![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/gifs/dashboard-domain/domain-registration-install.gif)

![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/images/domain_1.jpg)
...
![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/images/domain-10.jpg)
...
![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/images/domain-8.jpg)
...
![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/images/domain-nic-1.png)

در صفحه بازشده رابط های موجود را بر روی گزینه ی " **خودم و نمایندگان** " قرار دهید و بر روی گزینه **ثبت تغییرات** کلیک نمایید.

![ثبت دامنه IR در چابکان](https://s1.chabokan.net/docs/images/domain-nic-2.png)
