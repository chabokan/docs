...
برای نصب CLI اختصاصی چابکان کافیست صفحه [نصب CLI چابکان](/cli/install) را مشاهده کنید تا با طی کردن چند قدم کوتاه آن را به درستی در سیستم عامل خود نصب نمایید.
