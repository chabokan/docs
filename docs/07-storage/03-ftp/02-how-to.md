...
برای دریافت لینک مستقیم از FTP ابتدا سرویس FTP را ساخته و با استفاده از نرم افزار Fillzila به آن متصل شوید.[(آموزش نحوه ساخت FTP)](/storage/ftp/install/)

بعد از متصل شدن به سرویس، فایل مد نظر را در مسیر /data قرار دهید.

![نحوه کار با سرویس FTP چابکان](https://s1.chabokan.net/docs/images/ftp-connect-1.jpg)

بعد از قرار گیری فایل در مسیر /data نام فایل مد نظر را کپی نمایید و به دامین پیش فرض سرویس ftp خود اضافه نمایید.

![نحوه کار با سرویس FTP چابکان](https://s1.chabokan.net/docs/images/ftp-connect-3.jpg)
...
![نحوه کار با سرویس FTP چابکان](https://s1.chabokan.net/docs/images/ftp-connect-2.jpg)
