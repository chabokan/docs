...
title: "استقرار اولیه"
icon: "faRocket"
description: "در این بخش می خواهیم آموزش نحوه استقرار اولیه هاست Blitz را به شما آموزش دهیم"
---

# استقرار اولیه Blitz
---

در این بخش می خواهیم آموزش نحوه استقرار اولیه Blitz را به شما آموزش دهیم. Blitz یک فریمورک مبتنی بر Javascriptاست که
...
در این بخش می خواهیم آموزش نحوه استقرار اولیه Blitz را به شما آموزش دهیم. همانطور قبل‌تر اشاره کردیم ابتدا باید سرویس
`NodeJS` را ایجاد کنید. برای اینکار ابتدا به پنل کاربری مراجعه کرده و به قسمت ساخت سرویس
جدید > میزبانی آسان > `NodeJS` میرویم.
![استقرار Blitz در چابکان](https://s1.chabokan.net/docs/images/nodejs-docs-1.png)

پس از چند دقیقه، سرویس شما با موفقیت ساخته می‌شود. حال می‌توانید با آپلود سورس‌کد برنامه خود `Blitz` را روی سرویس‌های
...
حال سرویس شما آماده استفاده است و می‌توانید با مراجعه به دامنه‌ی خود در داشبورد سرویس خروجی را مشاهده
