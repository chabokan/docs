...
![استقرار Elasticsearch در چابکان](https://s1.chabokan.net/docs/images/elk-elasticsearch-2.jpg)
...
![استقرار Elasticsearch در چابکان](https://s1.chabokan.net/docs/images/elk-elasticsearch-1.jpg)


بعد از اتمام ساخت سرویس به قسمت پورت ها رفته و بر روی ویرایش پورت اصلی کلیک کرده و آنرا به `9200` تغییر میدهیم.

![استقرار Elasticsearch در چابکان](https://s1.chabokan.net/docs/images/elasticsearch-port.png)
...
![استقرار Kibana در چابکان](https://s1.chabokan.net/docs/images/elk-elasticsearch-2.jpg)
...
![استقرار Kibana در چابکان](https://s1.chabokan.net/docs/images/elk-kibana-1.jpg)


بعد از اتمام ساخت سرویس به قسمت پورت ها رفته و بر روی ویرایش پورت اصلی کلیک کرده و آنرا به `5601` تغییر میدهیم.

![استقرار Kibana در چابکان](https://s1.chabokan.net/docs/images/kibana-port.jpg)
...
![استقرار Logstash در چابکان](https://s1.chabokan.net/docs/images/elk-elasticsearch-2.jpg)
...
![استقرار Logstash در چابکان](https://s1.chabokan.net/docs/images/logstash-dockerfile.jpg)



بعد از اتمام ساخت سرویس به قسمت پورت ها رفته و بر روی ویرایش پورت اصلی کلیک کرده و آنرا به `5044` تغییر میدهیم.

![استقرار Logstash در چابکان](https://s1.chabokan.net/docs/images/port-logstash.png)
...
img="https://s1.chabokan.net/docs/images/elkstack-banner.png"
/>
