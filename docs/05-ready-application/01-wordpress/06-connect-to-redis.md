...
ابتدا سرویس [دیتابیس ابری Redis](/database/redis/install/) خود را بسازید. سپس در سرویس وردپرس خود به قسمت مدیریت فایل ها رفته و فایل `wp-config.php` را انتخاب کرده و گزینه `Edit` را کلیک کنید.
