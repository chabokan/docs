...
- اضافه شدن امکان محدودیت دسترسی به یک url خاص: [مستند](/features/domains/authentication/)
- اضافه شدن امکان فایروال برای دسترسی و عدم دسترسی بر اساس ip به یک url خاص: [مستند](/features/domains/firewall/)
