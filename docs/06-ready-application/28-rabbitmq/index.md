...
![نصب و راه‌اندازی RabbitMQ در چابکان](https://s1.chabokan.net/docs/gifs/rabbitmq-install.gif)

![نصب و راه‌اندازی RabbitMQ در چابکان](https://s1.chabokan.net/docs/images/rabbitmq-1.jpg)

بر روی نام دامنه پیشفرض سیستم که برای شما ایجاد شده کلیک نمایید تا وارد صفحه ورود `RabbitMQ` شوید

![نصب و راه‌اندازی RabbitMQ در چابکان](https://s1.chabokan.net/docs/images/rabbitmq-2.jpg)

از نام کاربری و رمز عبور داده شده در قسمت مشخصات سرویس برای ورود به `RabbitMQ` استفاده کنید.

![نصب و راه‌اندازی RabbitMQ در چابکان](https://s1.chabokan.net/docs/images/rabbitmq-3.jpg)
...
![نصب و راه‌اندازی RabbitMQ در چابکان](https://s1.chabokan.net/docs/images/rabbitmq-4.jpg)
...
<ServiceBanner
buyLink="https://hub.chabokan.net/fa/services/create/rabbitmq"
img="https://s1.chabokan.net/docs/images/rabbitmq-banner.png"
/>
