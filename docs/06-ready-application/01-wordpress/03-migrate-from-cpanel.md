...
اگر نیاز بود تا فایل ها جابجا شوند می توانید با خواندن صفحه [دستورات پایه کنسول](/general-tips/base-commands/) ابتدا با دستورات ساده آشنا شوید و با استفاده از آن ها، فایل های خود را جابجا بفرمایید.
