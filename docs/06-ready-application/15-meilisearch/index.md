...
![نصب و راه‌اندازی MeiliSearch در چابکان](https://s1.chabokan.net/docs/gifs/meilisearch-install.gif)

![نصب و راه‌اندازی MeiliSearch در چابکان](https://s1.chabokan.net/docs/images/meilisearch-platform-docs-1.jpg)
...
![نصب و راه‌اندازی MeiliSearch در چابکان](https://s1.chabokan.net/docs/images/meilisearch-platform-docs-2.jpg)

سپس `Master Key` داده شده در مشخصات سرویس را در کادر `admin API Key` وارد می کنید.

![نصب و راه‌اندازی MeiliSearch در چابکان](https://s1.chabokan.net/docs/images/meilisearch3.png)

حال برنامه شما آماده استفاده است و میتوانید با مراجعه به دامنه ی خود در داشبورد سرویس `Meilisearch` وارد برنامه شوید و یا دامنه ی اختصاصی خود را بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))

![نصب و راه‌اندازی MeiliSearch در چابکان](https://s1.chabokan.net/docs/images/meilisearch2.jpg)
...
<ServiceBanner
buyLink="https://hub.chabokan.net/fa/services/create/meilisearch"
img="https://s1.chabokan.net/docs/images/meilisearch-banner.png"
/>
