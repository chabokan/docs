...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-1.jpg)
...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-2.jpg)

سپس برای امنیت سرویس، مانند تصویر زیر بر روی قسمت `Actions` کلیک می کنیم.

![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-3.jpg)

حال به بخش `GUI` رفته و در قسمت `Authentication` نام کاربری و رمز عبور دلخواه را وارد نمایید.

![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-4.jpg)

حال برنامه شما آماده استفاده است و میتوانید با مراجعه به دامنه ی خود در داشبورد سرویس `Syncthing` وارد برنامه شوید و با استفاده از گزینه `Add Remote Device`  به دلخواه سیستم لوکال خود و یا سرور دیگری را برای sync دیتا به برنامه خود متصل نمایید. همچنین میتوانید  دامنه ی اختصاصی خود را نیز بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))

![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-5.jpg)
...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-5-1.jpg)
...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-6.jpg)

بعد از ورود به صفحه مدیریت برنامه در سیستم لوکال خود، از قسمت `Actions` بر روی `Show ID` کلیک نموده و `ID` برنامه را کپی نمایید:

![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-7.jpg)
...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-9.jpg)
...
![نصب و راه‌اندازی Syncthing در چابکان](https://s1.chabokan.net/docs/images/syncthing-docs-10.jpg)
...
<ServiceBanner
buyLink="https://hub.chabokan.net/fa/services/create/syncthing"
img="https://s1.chabokan.net/docs/images/syncthing-banner.jpg"
/>
