...
![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Screenshot-1402-06-04-at-4.58.39-PM-edited.png)

سپس در قسمت `Filename` نام بکاپ و در قسمت `Format` خروجی فرمت مورد نظر را وارد نمایید و روی گزینه بکاپ کلیک نمایید

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Screenshot-1402-06-04-at-4.58.49-PM-edited.png)
...
![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Screenshot-1402-06-04-at-5.11.07-PM-edited.png)

سپس روی آیکون `Storage Manager` کلیک کرده (همانند تصویر زیر)

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/pgadminasd.png)

در نهایت روی دانلود مانند تصویر زیر کلیک کرده تا از بکاپ خود خروجی بگیرید

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Screenshot-1402-06-04-at-5.11.28-PM-edited.png)

## بازگردانی

بعد از ایجاد دیتابیس خود روی دیتابیس راست کلیک نمایید سپس بر گزینه `Restore` کلیک نمایید

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Restore-1.png)

سپس روی گزینه `Folder` کیلیک نمایید

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Restore-2.png)

سپس روی گزینه `Upload` کلیک کرده و فایلی که در مرحله قبل `Backup` گرفتید را از سیستم خود آپلود نمایید

![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Restore-3.png)
...
![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Restore-4.png)
...
![نحوه Backup از دیتابیس در سرویس PGAdmin چابکان](https://s1.chabokan.net/docs/images/Restore-5.png)
