...
![نصب و راه‌اندازی PGAdmin در چابکان](https://s1.chabokan.net/docs/gifs/pgadmin-install.gif)

![نصب و راه‌اندازی PGAdmin در چابکان](https://s1.chabokan.net/docs/images/pgadmin-platform-doc-1.jpg)

بعد از دقایقی برنامه ی شما با موفقیت ساخته می شود و میتوانید با مراجعه به دامنه ی خود در سرویس `PGadmin` وارد برنامه شوید.

![نصب و راه‌اندازی PGAdmin در چابکان](https://s1.chabokan.net/docs/images/pgadmin-platform-doc-2.jpg)

ابتدا با مشخصات سرویس داده شده در داشبورد سرویس وارد `PGadmin` خود شوید.

![نصب و راه‌اندازی PGAdmin در چابکان](https://s1.chabokan.net/docs/images/pgadmin_12.jpg)

حال برنامه شما آماده استفاده است و میتوانید با مراجعه به دامنه ی خود در داشبورد سرویس `PGadmin` وارد برنامه شوید و یا دامنه ی اختصاصی خود را بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))

![نصب و راه‌اندازی PGAdmin در چابکان](https://s1.chabokan.net/docs/images/pgadmin_13.jpg)
