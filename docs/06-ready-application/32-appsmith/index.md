...
![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-0.jpg)

بعد از دقایقی برنامه ی شما با موفقیت ساخته می شود و میتوانید با مراجعه به دامنه ی خود در سرویس `Appsmith` وارد برنامه شوید.


![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-1.jpg)

سپس به صفحه ساخت صفحه ادمین منتقل می شوید و در این صفحه میتوانید مشخصات کاربر ادمین را وارد نمایید.

![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-2.jpg)
...
![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-3.jpg)
...
![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-4.jpg)


حال برنامه شما آماده استفاده است و میتوانید با مراجعه به دامنه ی خود در داشبورد سرویس `Appsmith` وارد برنامه شوید و یا دامنه ی اختصاصی خود را بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))

![نصب و راه‌اندازی Appsmith در چابکان](https://s1.chabokan.net/docs/images/appsmith-install-5.jpg)
