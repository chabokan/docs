...
![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/gifs/mattermost-install.gif)

![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/images/mattermost-platform-docs-1.jpg)
...
![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/images/mattermost-platform-docs-2.jpg)

سپس اطلاعات ورود شخصی خود را تنظیم می نمایید.

![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/images/mattermost_2.jpg)

حال میتوانید مستقیم به سیستم کنترل برنامه ی خود رفته و یا تیم جدید ساخته و سپس وارد سیستم کنترل شوید.

![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/images/mattermost_3.jpg)

حال برنامه شما آماده استفاده است و میتوانید با مراجعه به دامنه ی خود در داشبورد سرویس `Mattermost` وارد برنامه شوید و یا دامنه ی اختصاصی خود را بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))

![نصب و راه‌اندازی Mattermost در چابکان](https://s1.chabokan.net/docs/images/mattermost_4.jpg)
...
<ServiceBanner
buyLink="https://hub.chabokan.net/fa/services/create/mattermost"
img="https://s1.chabokan.net/docs/images/mattermost-banner.png"
/>
