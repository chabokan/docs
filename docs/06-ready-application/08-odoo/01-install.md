...
سپس میتوانید با مراجعه به دامنه ی خود در سرویس `Odoo` وارد برنامه شوید. همچنین میتوانید دامنه ی اختصاصی خود را بر روی برنامه ست نمایید.( [تنظیم دامنه](/features/domains/))
