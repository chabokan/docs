...
![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/gifs/metabase-install.gif)

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase-platform-docs-1.jpg)

بعد از دقایقی برنامه ی شما با موفقیت ساخته می شود و میتوانید با مراجعه به دامنه ی خود در سرویس `Metabase` وارد برنامه شوید.

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase-platform-docs-2.jpg)

ابتدا زبان برنامه را انتخاب میکنید.

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_2.jpg)

سپس اطلاعات مد نظر را برای ادمین وارد کنید.

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_3.jpg)

در مرحله ی بعد ابتدا بر روی `PostgreSQL` کلیک نموده و آنرا انتخاب کنید. سپس `Show more options` را کلیک کنید.

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_4.jpg)
...
![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_5.jpg)
...
![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_6.jpg)

در مرحله ی آخر نیز میتوانید ایمیل خود را جهت اطلاع از آخرین آپدیت های برنامه ی `Metabase` وارد نمایید.

![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_7.jpg)
...
![نصب و راه‌اندازی Metabase در چابکان](https://s1.chabokan.net/docs/images/metabase_8.jpg)
...
<ServiceBanner
buyLink="https://hub.chabokan.net/fa/services/create/metabase"
img="https://s1.chabokan.net/docs/images/metabase-banner.png"
/>
