...
اکنون می‌توانید جریان‌های کاری هوش مصنوعی خود را بسازید، مدیریت کنید و از قابلیت‌های متنوع Flowise بهره‌مند شوید. همچنین امکان تنظیم دامنه اختصاصی برای دسترسی آسان‌تر به برنامه وجود دارد. ([تنظیم دامنه](/features/domains/))
