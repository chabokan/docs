...
سرویس‌های اشتراکی قابل ارائه در هاست Django شامل موارد زیر می‌باشند (برای آشنایی بیشتر با تفاوت سرویس‌های اشتراکی و اختصاصی می‌توانید به این [مستند](/general-tips/share-db-vs-dedicated-db/) مراجعه فرمایید):
