...
برای استفاده از ویژگی **گیت ترافیک ورودی** در سرویس خود، کافی است ابتدا  [دامنه](/features/domains/) خود را به سرویس متصل نمایید.

- [افزودن دامنه از طریق DNS](/features/domains/add-dns/)
- [افزودن دامنه از طریق CDN](/features/domains/add-cdn/)
...
میتوانید برای آدرس های مختلف سرویس خود، رمز عبور و نام کاربری قرار دهید تا یک لایه امنیتی بیشتر برای آدرس های خاص سرویس خود داشته باشید. برای نحوه تنظیم این قابلیت به این [مستند](/features/domains/authentication/) مراجعه بفرمایید.
