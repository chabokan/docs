...
![نصب و راه‌اندازی دیتابیس MongoDB در چابکان](https://s1.chabokan.net/docs/gifs/mongodb-install.gif)

سرویس های ابری چابکان امکان راه اندازی با نسخه های مختلف را نیز دارند که شما می توانید نسخه موردنظر خود را انتخاب کنید.

![نصب و راه‌اندازی دیتابیس MongoDB در چابکان](https://s1.chabokan.net/docs/images/mariadb-start.png)
