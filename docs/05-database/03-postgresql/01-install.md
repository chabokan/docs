...
![نصب و راه‌اندازی دیتابیس PostgreSQL در چابکان](https://s1.chabokan.net/docs/gifs/mariadb-install.gif)

سرویس های ابری چابکان امکان راه اندازی با نسخه های مختلف را نیز دارند که شما می توانید نسخه موردنظر خود را انتخاب کنید.

![نصب و راه‌اندازی دیتابیس PostgreSQL در چابکان](https://s1.chabokan.net/docs/images/postgresql-start.png)
