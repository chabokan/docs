...
![نحوه Backup از سرویس دیتابیس Mysql چابکان](https://s1.chabokan.net/docs/images/database_backup_2.jpg)
...
![نحوه Backup از سرویس دیتابیس Mysql چابکان](https://s1.chabokan.net/docs/images/my_sql_connect_1.jpg)
...
:::
![نحوه Backup از سرویس دیتابیس Mysql چابکان](https://s1.chabokan.net/docs/images/my_sql_connect_2-edited.jpg)
...
![نحوه Backup از سرویس دیتابیس Mysql چابکان](https://s1.chabokan.net/docs/images/mysql_backup_3.jpg)
...
![نحوه Backup از سرویس دیتابیس Mysql چابکان](https://s1.chabokan.net/docs/images/mysql_backup_4.jpg)
