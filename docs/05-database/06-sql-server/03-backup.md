...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/database_backup_2.jpg)
...
### ایجاد بکاپ از دیتابیس
ابتدا وارد نرم افزار ssms شوید.[(آموزش نحوه اتصال به SSMS)](/database/sql-server/connect/)

حال بر روی دیتابیس مد نظر کلیک راست کرده و از بخش Tasks بر روی Back Up کلیک نمایید.

![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/backup-db-ssms.png)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-backup-1.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-backup-2.jpg)
...
ابتدا وارد نرم افزار [SSMS](/database/sql-server/connect/) شوید. سپس در SSMS، روی نام سرور راست کلیک کنید و "Restore Database" را انتخاب کنید.

![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-restore-2.jpg)

در بخش `Source،` روی `Device` کلیک کنید و بر روی دکمه `...` کلیک کنید تا پنجره `Select backup devices`باز شود.

![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-restore-3.jpg)


در صورتی که بکاپ خود را با استفاده از [روش بالا](/database/sql-server/backup/#%D8%A7%DB%8C%D8%AC%D8%A7%D8%AF-%D8%A8%DA%A9%D8%A7%D9%BE-%D8%A7%D8%B2-%D8%AF%DB%8C%D8%AA%D8%A7%D8%A8%DB%8C%D8%B3-1) تهیه نموده اید، به مرحله بعد مراجعه نمایید و در صورتی که نیاز به استفاده از بکاپ فایل لوکال خود دارید، میبایست ابتدا فایل بکاپ را در یک سایت آپلود نموده و لینک دانلود مستقیم آنرا دریافت نمایید.
...
```
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/terminal-for-database.jpg)

در پنجره `Select backup devices`، روی `Add` کلیک کنید و فایل بک آپ را انتخاب کنید و روی `OK` کلیک کنید.

![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-restore-7.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-restore-5.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-restore-6.jpg)
...
برای سیستم عامل مک پیشنهاد می شود از نرم افزار **Azure Data Studio** استفاده شود، بعد از نصب نرم افزار وارد آن شده و اطلاعات دیتابیس خود را وارد می نماییم.( [آموزش نحوه اتصال به **Azure Data Studio**](/database/sql-server/connect/))

![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-2.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-3.jpg)

بعد از اتمام عملیات پشتیبان‌گیری، پیغامی با عنوان "Backup completed successfully" نشان داده می‌شود.

### بازگردانی

ابتدا وارد نرم افزار Azure Data Studio شوید.[آموزش نحوه اتصال به Azure Data Studio](/database/sql-server/connect/)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-4.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-5.jpg)

در صورتی که بکاپ خود را با استفاده از [روش بالا](/database/sql-server/backup/#%D8%A7%DB%8C%D8%AC%D8%A7%D8%AF-%D8%A8%DA%A9%D8%A7%D9%BE-%D8%A7%D8%B2-%D8%AF%DB%8C%D8%AA%D8%A7%D8%A8%DB%8C%D8%B3-2) تهیه نموده اید، به مرحله بعد مراجعه نمایید و در صورتی که نیاز به استفاده از بکاپ فایل لوکال خود دارید، میبایست ابتدا فایل بکاپ را در یک سایت آپلود نموده و لینک دانلود مستقیم آنرا دریافت نمایید.
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-6.jpg)
...
![نحوه Backup از سرویس دیتابیس SQL Server چابکان](https://s1.chabokan.net/docs/images/mssql-connect-azure-7.jpg)
