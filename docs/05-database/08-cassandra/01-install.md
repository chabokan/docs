...
![نصب و راه‌اندازی دیتابیس Cassandra در چابکان](https://s1.chabokan.net/docs/gifs/cassandra-install.gif)

سرویس های ابری چابکان امکان راه اندازی با نسخه های مختلف را نیز دارند که شما می توانید نسخه موردنظر خود را انتخاب کنید.

![نصب و راه‌اندازی دیتابیس Cassandra در چابکان](https://s1.chabokan.net/docs/images/cassandra-start.png)
